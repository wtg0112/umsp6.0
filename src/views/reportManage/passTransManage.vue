  ...
  <div class="passTransManage">
    <el-card class="box-card">
      ...
      >
        <el-row :gutter="20">
          <el-col :span="6">
            <el-form-item prop="templateName" label="原通道名称">
              <el-input
                v-model="formData.templateName"
                placeholder="请输入原通道名称"
                size="small"
              ></el-input>
            </el-form-item>
          </el-col>
    ...
    <el-card class="box-card">
      ...
      >
        ...
        <el-table-column prop="name" label="原通道"></el-table-column>
        <el-table-column prop="name" label="运营商"></el-table-column>
        <el-table-column prop="name" label="目的通道"></el-table-column>
    ...
    >
      <el-form
        ...
        label-width="160px"
      >
        <el-form-item prop="type" label="原通道">
          <el-select
            size="small"
        ...
        <el-form-item prop="type" label="运营商">
          <el-select
            size="small"
            v-model="dialogFormData.content"
            placeholder="请选择运营商"
        ...
        <el-form-item prop="type" label="目的通道">
          <el-select
            size="small"
            v-model="dialogFormData.content"
            placeholder="请选择目的通道"
