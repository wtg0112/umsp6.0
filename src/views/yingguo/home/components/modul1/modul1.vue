...
import { getHome1 } from '@/api/yingguo.js'
export default {
  mixins: [mixin],
  data () {
    return {
      home1: {
        ...
        student_total: 0,
        chart: [
          { name: '申请数量', area_case_nu: 0, img: require('@/views/meiyan/home/components/modul1/image/mk1.png') },
          { name: '院校数量', area_case_nu: 0, img: require('@/views/meiyan/home/components/modul1/image/mk2.png') },
          { name: '学生数量', area_case_nu: 0, img: require('@/views/meiyan/home/components/modul1/image/mk3.png') },
          { name: '专业数量', area_case_nu: 0, img: require('@/views/meiyan/home/components/modul1/image/mk4.png') },
          { name: '申请项目数量', area_case_nu: 0, img: require('@/views/meiyan/home/components/modul1/image/mk5.png') },
          // { name: '录取数量', area_case_nu: 26159, img: require('@/views/meiyan/home/components/modul1/image/mk6.png') },
          { name: 'Offer数量', area_case_nu: 0, img: require('@/views/meiyan/home/components/modul1/image/mk6.png') }
        ],
        degree: [
  ...
  methods: {
    getData () {
      getHome1().then(res => {
        ...
        console.log('home1', JSON.parse(JSON.stringify(res.data)))
        this.home1 = res.data
      })
    }
  }
