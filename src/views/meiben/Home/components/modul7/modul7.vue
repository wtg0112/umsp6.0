<template>
  <div class="modul7">
    <div class="modul7_bck">
      <img src="./image/modul7_bck.png" alt="" />
    ...
    <div class="modul7_box">
      <div class="modul7_left">
        <div class="left1 wow animate__jackInTheBox">国内地区学生分布</div>
        <!-- <div
      ...
      <div class="modul7_right">
        ...
        <div class="right5 wow animate__bounceInRight" data-wow-delay="1.5s">
          <div class="right5_bottom ">
            <vue-seamless-scroll
              :data="home4.province_data"
              class="seamless-warp"
              :class-option="classOption"
            >
              <div
                class="right5_bottom_items"
                v-for="(item, key) in home4.province_data"
                :key="key"
                @click="goList('szdq',item.new_ProvName)"
              >
                <div>
                  <span>●</span>
                  {{ item.new_ProvName }}
...
<script>
import { getHome7 } from '@/api/meiben.js'
  ...
  created () {
    ...
    getHome7().then(res => {
      ...
      res.data.area_data.forEach((item, key) => {
        const index = key + 1
        item.img = require('@/views/meiyan/home/components/modul7/image/mk' +
          index +
          '.png')
      })
