<template>
  <div class="modul7">
    <div class="modul7_bck">
      <div class="modul7_bck_box wow animate__zoomIn">
    ...
    <div class="modul7_box">
      <div class="modul7_left">
        <div class="left1 wow animate__jackInTheBox">美国地区案例分布</div>
        <div
        ...
        <div class="left5 wow animate__bounceInLeft" data-wow-delay="0.7s">
          <div>
            <img src="./image/modul7_left1.png" alt="" />
            <div>
              <div>美国高中院校数量</div>
              <div>{{ home4.senior_num }}</div>
            </div>
          </div>
          <div>
            <img src="./image/modul7_left2.png" alt="" />
            <div>
              <div>美国高中申请数量</div>
              <div>{{ home4.case_senior_amount }}</div>
            </div>
          </div>
        </div>
        ...
        <div class="left7 wow animate__bounceInLeft" data-wow-delay="0.8s">
          <vue-seamless-scroll
            :data="home4.province_case_data"
            class="seamless-warp"
            :class-option="classOption"
          >
            <div
              class="left7_items"
              v-for="(item, key) in home4.province_case_data"
              :key="key"
            >
...
<script>
import { getHome8 } from '@/api/meiben.js'
  ...
  data () {
    return {
      ...
      mapMark: [
        ...
        //   name: '西北地区',
        //   area_case_nu: '431234',
        //   img: require('@/views/meiyan/home/components/modul7/image/mk1.png')
        // },
        // {
        //   name: '西南地区',
        //   area_case_nu: '431234',
        //   img: require('@/views/meiyan/home/components/modul7/image/mk2.png')
        // },
        // {
        //   name: '华中地区',
        //   area_case_nu: '431234',
        //   img: require('@/views/meiyan/home/components/modul7/image/mk3.png')
        // },
        // {
        //   name: '华南地区',
        //   area_case_nu: '431234',
        //   img: require('@/views/meiyan/home/components/modul7/image/mk4.png')
        // },
        // {
        //   name: '东北地区',
        //   area_case_nu: '431234',
        //   img: require('@/views/meiyan/home/components/modul7/image/mk5.png')
        // },
        // {
        //   name: '华北地区',
        //   area_case_nu: '431234',
        //   img: require('@/views/meiyan/home/components/modul7/image/mk6.png')
        // },
        // {
        //   name: '华东地区',
        //   area_case_nu: '431234',
        //   img: require('@/views/meiyan/home/components/modul7/image/mk7.png')
        // }
        // {
        //   name: '其他地区',
        //   area_case_nu: '431234',
        //   img: require('@/views/Japan/home/components/modul7/image/mk8.png')
        // }
      ],
      step: {
        direction: 0
  ...
  created () {
    ...
    getHome8().then(res => {
      res.data.area_data.forEach((item, key) => {
        const index = key + 1
        item.img = require('@/views/meiben/home/components/modul8/image/mk' +
          index +
          '.png')
      })
