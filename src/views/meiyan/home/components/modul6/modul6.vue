  ...
  <div class="modul6">
    ...
    <div class="modul6_box">
      <div class="modul6_left">
        ...
        <div class="left2  wow animate__bounceInLeft" data-wow-delay='0.1s'>
          ...
          <div class="left2_bottom ">
            <vue-seamless-scroll :data="home6.total_detail" class="seamless-warp" :class-option="classOption">
              <div class="left2_bottom_items" v-for="(item,key) in home6.total_detail" :key="key" @click="goList('gnbyyxname',item.name)">
                <div>
                  <span>●</span>
                  {{item.name}}
                </div>
        ...
        <div class="left3 wow animate__bounceInLeft" data-wow-delay='0.3s'>
          <div v-for="(item,key) in home6.rank_school" :key="key">
      ...
      <div class="modul6_right">
        <img class="right1 wow animate__bounceInRight" data-wow-delay='0.4s' src="./image/modul6_textImg.png" alt="">
        ...
        <div class="right4 wow animate__bounceInRight" data-wow-delay='0.7s'>
          <span>{{home6.proportion.value}}%</span>
          <img src="./image/icon_lvjt.png" alt="">
        ...
        <div class="right7 wow animate__bounceInRight"  data-wow-delay='1s' >
            <vue-seamless-scroll :data="home6.college" class="seamless-warp" :class-option="classOption">
              <div class="right7_items" v-for="(item,key) in home6.college" :key="key" @click="goList('gnbyyxname',item.name)">
...
<script>
import { getHome6 } from '@/api/meiyan.js'
...
export default {
  ...
  methods: {
    charts () {
      ...
      this.home6.chart_school.forEach((item, index) => {
        const colorIndex = index % colorLen
        item.color = color[colorIndex]
      })
      chart.data = this.home6.chart_school
      // chart.colors.list = [
