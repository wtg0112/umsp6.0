  ...
  <div class="upstreamOrderManage">
    <el-card class="box-card">
      ...
      >
        <el-row :gutter="20">
          <el-col :span="6">
            <el-form-item prop="templateName" label="上行指令">
              <el-input
    ...
    <el-card class="box-card">
      ...
      >
        ...
        <el-table-column prop="name" label="上行指令"></el-table-column>
        <el-table-column prop="name" label="所属渠道"></el-table-column>
        <el-table-column prop="name" label="匹配方式"></el-table-column>
        <el-table-column prop="name" label="所属路由"></el-table-column>
    ...
    >
      <el-form
        ...
        label-width="160px"
      >
        <el-form-item prop="name" label="上行指令">
          <el-input
        ...
        <el-form-item prop="type" label="匹配方式">
          <el-select
            size="small"
            v-model="dialogFormData.content"
            placeholder="请选择匹配方式"
        ...
        <el-form-item prop="type" label="所属路由">
          <el-select
            size="small"
            v-model="dialogFormData.content"
            placeholder="请选择所属路由"
