...
const mixin = {
      ...
      alOption: {
        ...
        common: {
          ...
          ieltsList: [
            ...
            { name: '6以上', value: '6-999' },
            // { name: '6.5', value: '6.5-6.5' },
            { name: '7以上', value: '7-999' }
          ],
          gmatList: [
            // { name: "不限", value: "" },
            { name: '550以上', value: '550-999' },
            { name: '600以上', value: '600-999' },
            { name: '650以上', value: '650-999' },
            { name: '700以上', value: '700-999' },
            { name: '750以上', value: '750-999' }
          ],
          greList: [
            // { name: "不限", value: "" },
          ...
          satList: [
            ...
            { name: '1000以上', value: '1000-2400' },
            { name: '1500以上', value: '1500-2400' },
            { name: '2000以上', value: '2000-2400' }
          ],
          actList: [
            // { name: "不限", value: "" },
  ...
  methods: {
    ...
    getCaseChart () {
      caseChart({}).then(res => {
        this.amXuewei = res.data.xueli
        this.amXsbj = res.data.beijing
        this.amHwbj = res.data.haiwai
        this.amSqnf = res.data.rudu
        this.amGzbj = res.data.gngztype
