  ...
  <div class="case">
        ...
        <div class="filtrate_xuanxiang">
          <div class="xuanxiang">
            ...
            <el-radio-group v-model="xuewei">
              <el-radio-button
                v-for="(item, key) in alOption.yingguo.xueweiList"
                :key="key"
                :label="item.value"
    ...
    <div class="center">
      <div class="center_left">
        ...
        >
          <el-option
            v-for="item in alOption.yingguo.limitList"
            :key="item.value"
      ...
      <div class="center_right">
        ...
        >
          <el-option
            v-for="item in alOption.yingguo.jpPaiming"
            :key="item.id"
            :label="item.name"
            :value="item.id"
          ></el-option>
