  ...
  <div class="modul3">
    ...
    <div class="modul3_box">
      <div class="modul3_left">
        ...
        <div class="left2  wow animate__bounceInLeft" data-wow-delay='0.1s'>
          <div class="left2_top">
            ...
            <div class="t2">
              <span>{{home3.case_total}}</span>
              <img src="./image/icon_lvjt.png" alt="">
             {{home3.case_total_up_value}}%
            </div>
          </div>
      ...
      <div class="modul3_right">
        ...
        <div class="right2 wow animate__bounceInRight" data-wow-delay='0.5s'>美研录取案例数量</div>
...
<script>
import { getHome3 } from '@/api/meiyan.js'
...
export default {
  ...
  methods: {
    charts () {
      ...
      chart.data = this.home3.quantity_show
      // chart.data = [{
      //   category: 'Research',
      //   value: 80,
      //   full: 100
