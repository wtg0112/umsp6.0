<template>
  <div class="modul4">
    <div class="modul4_bck">
      ...
      <div class="modul4_bck_box wow animate__zoomIn">
    ...
    <div class="modul4_box">
      <div class="modul4_left">
        ...
        <div class="left5 wow animate__bounceInLeft" data-wow-delay="0.7s">
          <div>
            <img src="./image/modul_left1.png" alt="" />
            <div>
              <div>北上广地区</div>
          ...
          <div>
            <img src="./image/modul_left2.png" alt="" />
            <div>
              <div>江浙沪地区</div>
      ...
      <div class="modul4_right">
        ...
        <div class="right4 wow animate__bounceInRight" data-wow-delay="1.4s">
          <img src="./image/modul_right_border.png" alt="" />
        </div>
...
<script>
import { getHome4 } from '@/api/yingguo.js'
      ...
      mapMark: [
        {
          name: '西北地区',
          area_case_nu: '431234',
          img: require('@/views/yingguo/home/components/modul4/image/mk1.png')
        },
        {
          name: '西南地区',
          area_case_nu: '431234',
          img: require('@/views/yingguo/home/components/modul4/image/mk2.png')
        },
        {
          name: '华中地区',
          area_case_nu: '431234',
          img: require('@/views/yingguo/home/components/modul4/image/mk3.png')
        },
        {
          name: '华南地区',
          area_case_nu: '431234',
          img: require('@/views/yingguo/home/components/modul4/image/mk4.png')
        },
        {
          name: '东北地区',
          area_case_nu: '431234',
          img: require('@/views/yingguo/home/components/modul4/image/mk5.png')
        },
        {
          name: '华北地区',
          area_case_nu: '431234',
          img: require('@/views/yingguo/home/components/modul4/image/mk6.png')
        },
        {
          name: '华东地区',
          area_case_nu: '431234',
          img: require('@/views/yingguo/home/components/modul4/image/mk7.png')
        }
        // {
        //   name: '其他地区',
        //   area_case_nu: '431234',
  ...
  created () {
    ...
    getHome4().then(res => {
      ...
      res.data.area_data.forEach((item, key) => {
        const index = key + 1
        item.img = require('@/views/yingguo/home/components/modul4/image/mk' +
          index +
          '.png')
      })
