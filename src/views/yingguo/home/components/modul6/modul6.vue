  ...
  <div class="modul3">
    ...
    <div class="modul3_box">
      <div class="modul3_left">
        <div class="left1 wow animate__jackInTheBox">英国GPA成绩分析统计</div>
        <div class="left2  wow animate__bounceInLeft" data-wow-delay='0.1s'>
          <div class="left2_top">
            <img src="./image/yuan.png" alt="">
            <div class="t1">Total Detail</div>
            <div class="t2">
              <span>{{home6.case_total}}</span>
              <img src="./image/icon_lvjt.png" alt="">
             {{home6.case_total_up_value}}%
            </div>
          </div>
          <div class="left2_bottom ">
            <vue-seamless-scroll :data="home6.quantity" class="seamless-warp" :class-option="classOption">
              <div class="left2_bottom_items" v-for="(item,key) in home6.quantity" :key="key" @click="goList(item.key,item.val)">
                <div>
                  <span>●</span>
                  {{item.name}}
                </div>
        ...
        <div class="left3 wow animate__bounceInLeft" data-wow-delay='0.3s'>
          <div>
            ...
            <div class="left3_t2">
              <span>{{home6.admission.value}}</span>
              <img src="./image/icon_lvjt.png" alt="">
              {{home6.admission.up_value}}%
            </div>
      ...
      <div class="modul3_right">
        ...
        <div class="right2 wow animate__bounceInRight" data-wow-delay='0.5s'>GPA录取案例数量</div>
        ...
        <div class="right4 wow animate__bounceInRight" data-wow-delay='0.7s'>
          <span>{{home6.admission_case.value}}</span>
          <img src="./image/icon_lvjt.png" alt="">
          {{home6.admission_case.up_value}}%
        </div>
        ...
        <div class="right7 wow animate__bounceInRight"  data-wow-delay='1s' >
            <vue-seamless-scroll :data="home6.data" class="seamless-warp" :class-option="classOption">
              <div class="right7_items" v-for="(item,key) in home6.data" :key="key" @click="goDetails(item)">
...
<script>
import { getHome6 } from '@/api/yingguo.js'
...
export default {
  ...
  data () {
    return {
      home6: {
        admission: { value: 9281, up_value: 48.03 },
        admission_case: { value: 26159, up_value: 47.63 },
        case_total: 26.198,
        case_total_up_value: 47.65,
        data: [],
        quantity: [],
  ...
  methods: {
    charts () {
      ...
      chart.data = this.home6.quantity_show
      // chart.data = [{
      //   category: 'Research',
      //   value: 80,
      //   full: 100
    ...
    getData () {
      getHome6().then(res => {
        ...
        res.data.quantity_show.forEach((item, key) => {
          item.fill = 100
        })
        this.home6 = res.data
        this.charts()
