        ...
        <el-tab-pane label="数据表">
          ...
          >
            <el-table-column
              ...
              sortable
            ></el-table-column>
            <el-table-column prop="organ" label="用户"></el-table-column>
            <el-table-column
              prop="messageType"
              label="信息类型"
            ></el-table-column>
            ...
            <el-table-column
              ...
              width="200"
            ></el-table-column>
            <el-table-column prop="sum" label="总价" sortable></el-table-column>
          </el-table>
          <el-pagination
            background
...
.operatorStatistic /deep/ .el-tabs__nav-scroll {
  padding-left: 20px;
}
</style>
