  ...
  <div class="wxManage">
    <el-card class="box-card">
      ...
      >
        <el-row :gutter="20">
          <el-col :span="6">
            <el-form-item prop="templateName" label="公众号名称">
              <el-input
    ...
    >
      ...
      >
        ...
        <el-form-item prop="name" label="token_url" v-if="isAdd">
          <el-input
            v-model="dialogFormData.name"
            size="small"
          ></el-input>
        </el-form-item>
        <el-form-item prop="name" label="模板发送地址" v-if="isAdd">
          <el-input
            v-model="dialogFormData.name"
            size="small"
          ></el-input>
