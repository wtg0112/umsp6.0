<template>
  <el-table
    ...
    >
      ...
      <el-table-column label="TOEFL/IELTS">
        <template slot-scope="scope">
          <div>{{ scope.row.toefl_ielts_decimal | empty }}</div>
        </template>
      </el-table-column>
      <el-table-column label="GRE">
        <template slot-scope="scope">
          <div>{{ scope.row.gre_decimal | empty }}</div>
        </template>
      </el-table-column>
      <el-table-column label="GMAT">
        <template slot-scope="scope">
          <div>{{ scope.row.gmat_decimal | empty }}</div>
        </template>
      </el-table-column>
      <el-table-column label="附件">
        <template slot-scope="scope">
          <div>{{ scope.row.customFileNum_decimal | empty }}</div>
        </template>
      </el-table-column>
    </el-table>
</template>
