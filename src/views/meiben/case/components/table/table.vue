<template>
  <el-table
    ...
    >
      <el-table-column label="Student Name" min-width='110px'>
        ...
        <template slot-scope="scope">
          <div class="tabname">
            ...
            <img v-if="scope.row.isBoutique=='1'" class="jp" src="./img/jp.png" alt="">
            <div>
              {{ scope.row.khname }}
      ...
      <el-table-column label="申请院校" min-width='150px'>
        <template slot-scope="scope">
      ...
      <el-table-column label="毕业院校" min-width='150px'>
        <template slot-scope="scope">
      ...
      <el-table-column label="本科专业" min-width='100px' v-if="xuewei=='本转'">
        <template slot-scope="scope">
      ...
      <el-table-column label="SAT/ACT" v-if="xuewei=='新生'">
        <template slot-scope="scope">
          <div>{{ scope.row.sat_act_decimal | empty }}</div>
        </template>
      </el-table-column>
      <el-table-column label="入读时间">
        <template slot-scope="scope">
