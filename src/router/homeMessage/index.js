const homeMessage = [
  {
    ...
    meta: { keepAlive:true,title: '国内短信' },
    ...
    children: [
      {
        ...
        meta: { keepAlive: true,isUseCache: false,  title: '快速发送' },
        tips:'最多1000个手机号'
      },
      {
        path: 'templateSend',
        ...
        meta: { keepAlive: true,isUseCache: false,  title: '模板发送' }
      },
      {
        path: 'fileSend',
        name: '文件发送',
        component: () => import('@/views/homeMessage/fileSend'),
        meta: { keepAlive: true, isUseCache: false, title: '文件发送' },
        tips:'建议：任务名称不能相同'
      },
      {
        path: 'weekQuery',
      ...
      },
      {
        ...
        meta: { keepAlive: true,isUseCache: false,  title: '历史查询' }
      },
      {
        path: 'upSearch',
        name: '上行查询',
